$(function(){
  ...
  function move(bool){
      ...
      // 第五部分
      $('.five_tab li').click(function(){
        //添加类名
        $(this).addClass('red').siblings().removeClass('red');

        var index = $(this).index();
        $('.bottom_none').eq(index).show().siblings().hide();

        $('.bot_none').eq(index).show().siblings().hide();
      })
